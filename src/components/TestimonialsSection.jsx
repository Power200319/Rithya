        ...
        <div className="container mx-auto px-4 py-10">
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              ...
              <p className="font-semibold text-navy-800 text-center text-head mt-7">{topTestimonial.name}</p>
            </Card>
          </div>
            ...
            {bottomTestimonials.map((testimonial, index) => (
              <Card
                ...
                className={`p-6 bg-gray-50 hover-scale transition-all duration-300 ${
                  activeIndex === index + 1 ? "border-aqua-500 shadow-lg bg-white" : ""
                }`}
              ...
              >
                ...
                <p className="font-semibold text-navy-800 text-center text-head mt-7">{testimonial.name}</p>
              </Card>
            ))}
          </div>
        </div>
